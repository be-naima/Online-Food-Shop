...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span id="hi"> &nbspNemaTo🧁</span></a>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Nematoo.com is an online shop available in Chattogram. We believe time is valuable to our fellow residents, and that they should not have to waste hours in traffic, brave bad weather and wait in line just to buy basic necessities like delicious foods! This is why Nematoo delivers everything you need right at your door-step and at no additional cost.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>

      <div class="box">
         <img src="images/deliver.webp" alt="">
         <h3>30 minutes delivery</h3>
         <p>Nemato does not penalize its drivers for late delivery.Nemato preserves the right to withdraw the service guarantee without prior information.30 minutes delivery guarantee not applicable on New years , on Christmas and  Eid , the service guarantee may be withdrawn temporarily in view of difficult operating conditions for delivery.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
      ...
      <div class="box">
         ...
         <p>Share our website by any social media platforms and share with your friends. Your friends get a happy meal for using this website.By register into new account they can get delicious foods within a reasonable price.Treat your friends and make your bond more strong.Save your time by using our website........................Have a Happy Day!!!</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>naimafardous03@gmail.com</p>
      </div>

   </div>

   <div class="credit">
      &copy; <?= date('Y'); ?>| All rights reserved!  by <span>Nematoo.com</span> 
   </div>
